...
public interface IRestClientsConfig {
    ...
    public static IRestClientsConfig getInstance() {
        InstanceHandle<IRestClientsConfig> configHandle;
        try {
            configHandle = Arc.container().instance(IRestClientsConfig.class);
